                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <input 
                            ...
                            className="w-full p-3 bg-slate-800 border border-slate-600 text-white outline-none font-mono focus:border-orange-500 rounded-none placeholder-slate-600"
                        />
                    </div>
                </div>
